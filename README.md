# <strong>LALIT JADHAV</strong>

##  Hi, I am a React/React Native/Frontend Developer 👩‍💻

🔭 Highlights: Currently I am working as a full-time <strong>React/Frontend Developer</strong>. I am using Styled Components, React/Redux, TypeScript, CSS, Material UI, Git, Gitlab, Figma & Testing tools like Jest and Cypress.Apart from the above skills, I like to create applications using Tailwind CSS, Nodejs, SASS and MongoDB too.
